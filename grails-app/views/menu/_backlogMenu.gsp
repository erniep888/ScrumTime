<div id="secondLevelMenuDiv" style="text-align:left">
    <table class="font14" cellpadding="0" cellspacing="0" border="0">
        <tr>
            ...
            <g:if test="${!backlogMenuSelection || backlogMenuSelection == '' || backlogMenuSelection == 'product'}">
            ...
            <g:else>
                <td style="width:88px"><a href="${createLink(controller: 'backlog', action: 'index')}">Product</a></td>
