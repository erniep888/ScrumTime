        ...
        <tr>
            ...
            <td style="text-align:right">
                <table cellpadding="0" cellspacing="0" align="right">
                    <tr>
                        <td style="font-size:14px;padding-right:4px">Sprint:</td>
                        <td><g:select style="font-size:12px" name="currentSprint" value="${currentSprint?.name}"
                            from="${sprints}" optionKey="id" optionValue="name"
                            noSelection="['-1':'----------------------']"/></td>
                        <td style="font-size:14px;padding-right:4px">Product:</td>
                        <td><g:select style="font-size:12px" name="currentProduct" value="${currentProduct?.name}"
