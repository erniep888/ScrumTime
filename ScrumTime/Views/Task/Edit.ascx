<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<ScrumTime.Models.Task>" %>
    ...
    <tr id="taskRow_<%: Model.TaskId %>" class="taskRow">
        ...
        <td style="vertical-align:middle;text-align:center;width:194px;border:0px;"><a href="#" class="noticableLink" onclick="saveTaskRowEdit(<%: Model.TaskId %>, <%: Model.StoryId %> );">Save</a> | <a href="#" class="noticableLink" onclick="cancelTaskRowEdit(<%: Model.TaskId %>, <%: Model.StoryId %> );">Cancel</a></td>
    </tr>