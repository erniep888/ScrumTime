<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<ScrumTime.Models.Story>" %>
    ...
    <td class="story_<%= Model.StoryId %>" style="vertical-align:middle;text-align:center;width:108px;border:0px;"><a class="simpleLink" href="#" style="font-style:italic;"><%= Model.UserDefinedId %></a></td>
    ...
    <td style="vertical-align:middle;text-align:center;width:194px;border:0px;">Delete | <a id="storyTasks_<%= Model.StoryId %>" class="simpleLink" href="#">Tasks</a></td>
