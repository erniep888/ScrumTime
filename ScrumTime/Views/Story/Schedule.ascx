...
<tr id="storyRow_<%: Model.StoryModel.StoryId %>" class="storyRow" style="border:0px" >                
   <td style="padding:0px;margin:0px;border:0px;" colspan="6">           
     <table style="width:940px;font-family:Verdana;padding:0px;margin:0px;border:0px" cellpadding="0" cellspacing="0">
            <tr style="padding:0px;margin:0px;border:0px;">
                <%
                    Html.RenderPartial("~/Views/Story/ReadOnlyColumns.ascx", Model.StoryModel);
                %>
            </tr>
            <tr style="padding:0px;margin:0px;border:0px;">
                <td colspan="6" style="border:0px">
                    <div id="storyScheduleContainerId_<%: Model.StoryModel.StoryId %>" style="margin-left:10px;margin-right:10px;margin-bottom:10px;border:1px dotted #444;">
   ...
   <script type="text/javascript" language="javascript">
       setupStoryScheduleEditorCancelButton(<%: Model.StoryModel.StoryId %>);    
