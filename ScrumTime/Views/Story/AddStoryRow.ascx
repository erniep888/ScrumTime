<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<ScrumTime.ViewModels.StoryViewModel>" %>
    ...
    <% using (Html.BeginForm("Story", "Add", FormMethod.Post, new { id = "addStoryFormId" }))
       { %>
        ...
        <td style="vertical-align:middle;text-align:center;width:108px;border:0px;"><textarea rows="3" style="width:100%;font-family:Verdana;font-style:italic;"><%: Model.StoryModel.UserDefinedId%></textarea></td>
        ...
        <td style="vertical-align:middle;text-align:center;width:194px;font-weight:bold;color:#0035a0;border:0px;"><a href="#" id="addStorySaveLinkId" class="noticableLink">Save</a> | <a href="#" class="noticableLink" onclick="cancelStoryRowEdit('#storyRow_<%: Model.StoryModel.StoryId %>', <%: Model.StoryModel.StoryId %>);">Cancel</a></td>
    <% } %>
