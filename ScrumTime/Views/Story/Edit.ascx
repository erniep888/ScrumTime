    ...
    <%
     ...
     <tr id="storyRow_<%: Model.StoryModel.StoryId %>" class="storyRow" style="border:0px" >
        <td style="padding:0" colspan="6">
            <table style="padding:0" cellpadding="0" cellspacing="0">
                <tbody>
                    <tr>
                        ...
                        <td style="vertical-align:middle;text-align:center;border:0px;"><textarea id="storyUserDefinedId_<%: Model.StoryModel.StoryId %>" rows="3" style="width:100px;font-family:Verdana;font-style:italic;vertical-align:middle;text-align:center;"><%: Model.StoryModel.UserDefinedId%></textarea></td>
