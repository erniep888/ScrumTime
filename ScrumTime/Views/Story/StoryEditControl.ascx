<%@ Control Language="C#" Inherits="System.Web.Mvc.ViewUserControl<ScrumTime.Models.Story>" %>
    <td style="vertical-align:middle;text-align:center;width:78px;border:0px;">1</td>
    <td style="vertical-align:middle;text-align:center;width:78px;border:0px;">10</td>
    <td style="width:540px;"><textarea rows="3" style="width:100%;font-family:Verdana;">As the author, I want to see the text in multiple fonts.</textarea></td>
