...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <%--Left News--%>
    <div style="width:456px;height:300px;border: 2px solid #999; position:relative;float:left;">
        <div style="width:100%;height:25px;background-color:#ffd;border-bottom: 2px solid #999">
            <div style="margin-left: 19px; font-size: 15px;color:#666; padding-top:2px; font-weight:bold">News</div>
        </div>
    ...
    <div style="width:456px;height:300px;border: 2px solid #999;position:relative; float:right;">
        <div style="width:100%;height:25px;background-color:#ffd;border-bottom: 2px solid #999">
            <div style="margin-left: 19px; font-size: 15px;color:#666; padding-top:2px; font-weight:bold">Release Schedule</div>
        </div>
        <div style="overflow-y: scroll;overflow-x:hidden;height:273px;">
            ...
            <div style="text-align:left;padding:0;margin:0;position:relative;float:left;margin-top:16px;width:450px"">
                <div style="padding:0;margin:0">
                    ...
                    <p style="position:relative;float:left;margin:0;padding:0;font-weight:bold;margin-top:12px;margin-left:12px;color:#c44;font-size:12px;width:104px;text-align:center;">Not for public</p>
    ...
    <div style="width:960px;height:160px;border: 2px solid #999;position:relative; float:left;margin-top:26px;">
        <div style="width:100%;height:25px;background-color:#ffd;border-bottom: 2px solid #999">
            <div style="margin-left: 19px; font-size: 15px;color:#666; padding-top:2px; font-weight:bold">Documentation</div>
        </div>
        <div style="text-align:left;padding:0;margin:0">
            <div style="padding:0;margin:0">
