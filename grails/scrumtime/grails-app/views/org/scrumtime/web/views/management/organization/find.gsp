...
<body>
<center>
<g:form name="searchForm" url="[controller:'organization']">
<div class="subWindow findManagementWindow">
<div class="subWindowTitle">Find Organizations</div>
...
<div class="subWindowTitle">Search Results</div>
  ...
  <td class="tableHeader width250">Members</td>
  <td class="tableHeader width200">Administrators</td>
  <td class="tableHeader width75">Products&nbsp;&nbsp;&nbsp;&nbsp;</td>
  </tr>
  </table>
  <div class="tableDataDiv subSearchResultsDataHeight">
    <table class="width100Percent" cellpadding="0" cellspacing="0">
      <g:each var="organization" in="${organizations}">
      <tr>
        ...
        <td class="tableData width250">${organization?.members?.size()}</td>
        <td class="tableData width200">${organization?.admins?.size()}</td>
        <td class="tableData width75">${organization?.products?.size()}</td>
      </tr>
      </g:each>
    </table>
  </div>
